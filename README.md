...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1f6feb,100:58a6ff&height=220&section=header&text=Aayush%20Rai&fontSize=65&fontColor=ffffff&fontAlignY=40&desc=Full%20Stack%20Developer%20%7C%20AI%20Integrations%20%7C%20Building%20Things%20That%20Matter&descAlignY=60&descSize=16&animation=fadeIn" />

<br/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&color=58A6FF&center=true&vCenter=true&width=600&lines=3%20+Years+of+Full+Stack+Development;React.js+%7C+Next.js+%7C+Node.js+%7C+TypeScript;Integrating+AI+into+Real+Products;Always+Learning+%E2%80%94+Always+Shipping+%F0%9F%9A%80)](https://git.io/typing-svg)
...
<details open>
<summary><b>🏢 Kandid Technologies — Full Stack Developer &nbsp;|&nbsp; Jan 2025 – Present</b></summary>
<br/>

**Project: SLB Internal Tools Integration**

- ⚡ Architected scalable **React.js** applications with Hooks, Context API and performance patterns for enterprise-grade internal tooling
- 🚀 Applied **lazy loading, code splitting & memoization** — measurably improved UI responsiveness on large datasets
- 🔌 Designed and owned **RESTful API** layers using Node.js + Express.js including auth, data flow, and business logic
- 🛠️ Diagnosed and resolved critical admin UI timeout issues by optimizing DB queries and API response handling
- 📋 Operated in **Agile/Scrum** with Git, Azure DevOps, Jira for structured delivery and code reviews

</details>

<details>
<summary><b>🏢 Kandid Technologies — Software Developer &nbsp;|&nbsp; Nov 2023 – Dec 2024</b></summary>
<br/>
...
<details>
<summary><b>🏢 Kandid Technologies — Software Developer Intern &nbsp;|&nbsp; Jul 2023 – Oct 2023</b></summary>
<br/>

- 🌱 Contributed to full-stack features using **React.js, Node.js, Express.js & MySQL** in production codebases
- 🐛 Delivered bug fixes and feature enhancements; first exposure to enterprise-scale development workflows
- 🎨 Built UI components and assisted in API integrations across active client projects
...
![Exploring](https://img.shields.io/badge/Exploring-ML_Concepts-e3b341?style=for-the-badge&logo=python&logoColor=white)
...
> A full-stack AI-powered journaling app that understands your emotions and responds with personalised feedback and music recommendations.
...
### 🗺️ SkyServe — GeoJSON Visualization Platform &nbsp; ![Status](https://img.shields.io/badge/✓-Completed-39d353?style=flat-square)

> Full-stack platform to upload, manage and visualize geospatial files on interactive maps with drawing, editing and spatial analysis tools.

| Feature | Status |
|---|---|
| User authentication & protected routes | ✅ |
| GeoJSON & KML file upload (Multer) | ✅ |
| Interactive map visualization (Mapbox GL JS) | ✅ |
| Shape drawing & editing (Mapbox Draw) | ✅ |
| Hover cards with metadata | ✅ |
| Area & distance calculation (Turf.js) | ✅ |
...
📚 AI / ML Fundamentals
    ...
    ├── Prompt Engineering & LLM patterns
    ├── Building smarter features with AI APIs
    └── Integrating ML models into web products

🎯 Goal → Build AI-native full-stack products
```
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Chhattisgarh Swami Vivekanand Technical University (CSVTU) &nbsp;|&nbsp; `2018 – 2022`
...
> *"Good code is its own best documentation." — Write it. Ship it. Improve it.* 💻
